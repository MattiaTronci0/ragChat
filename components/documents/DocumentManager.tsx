  ...
  return (
    <div className="flex flex-col h-full overflow-hidden p-4 md:p-6 gap-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6 flex-grow overflow-hidden">
        ...
        <div className="flex-1 bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg border border-gray-200 overflow-y-auto p-6 animate-fade-in [animation-delay:300ms]">
